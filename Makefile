.PHONY: validate install update phpcs phpcbf php73compatibility php81compatibility phpstan analyze tests testdox ci clean
...
php73compatibility: vendor/bin/phpstan build/reports/phpstan
	$(call header,Checking PHP 7.3 compatibility)
	@./vendor/bin/phpstan analyse --configuration=./ci/php73-compatibility.neon --error-format=table
...
ci: clean validate install phpcs tests php73compatibility php81compatibility analyze
